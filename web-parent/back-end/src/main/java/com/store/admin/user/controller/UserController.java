...
import com.store.admin.user.UserNotFoundException;
import com.store.admin.user.UserService;
import com.store.admin.user.export.UserCsvExporter;
import com.store.admin.user.export.UserExcelExporter;
import com.store.admin.user.export.UserPdfExporter;
...
public class UserController {
    ...
    public String deleteUser(@PathVariable("id") Integer id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes
                    .addFlashAttribute("message", "The user has been deleted successfully");
        } catch (UserNotFoundException e) {
            redirectAttributes.addFlashAttribute("message", e.getMessage());
        }
        return "redirect:/users";
    ...
    public String enableUser(@PathVariable("id") Integer id, @PathVariable("status") boolean enabled,
                             RedirectAttributes redirectAttributes) {
        userService.updateUserEnabledStatus(id, enabled);
        String status = enabled ? "enabled" : "disabled";
        String message = String.format("The user ID %s has been %s", id, status);
